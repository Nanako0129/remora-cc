...
def prepare_coralline_config(env: dict[str, str], source_config: str) -> None:
    ...
    overriding remora's environment values. The wrapper sources the original config
    first and then assigns the scoped paths, so isolation wins at the final layer.
    """
